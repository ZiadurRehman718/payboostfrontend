  ...
  return (
    <div className="container md:w-4/5  mx-auto shadow-2xl my-8">
      <div className="max-w-3/4 mx-auto">
        <h1 className="text-center text-5xl font-semibold my-10">Refund Policy </h1>

        <div className="text-lg">
          <p className="p-4">Thank you for paying your wireless prepaid phone bill at payboostbills.com.</p>

          <h2 className="text-2xl p-4">Please read this Return and Refund Policy carefully.</h2>
          <p className="p-4">Our website is fully integrated with all paid carriers via API and all payments are made within 5 minutes after a transaction is approved.</p>
